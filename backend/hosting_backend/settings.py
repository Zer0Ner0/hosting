...
SECRET_KEY = 'django-insecure-*(1!4&&!*_&3%6^%3#klv$*3_ma)3dvdstuj9gu-c)q3_c096('
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'hosting',
    'api',  # Assuming you have an 'api' app for API endpoints
    'blog',
...
# CORS settings
CORS_ALLOW_ALL_ORIGINS = True  # or configure properly later
